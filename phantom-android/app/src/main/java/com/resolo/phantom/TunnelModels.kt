...
object TunnelActions {
    const val ACTION_CONNECT = "com.resolo.phantom.action.CONNECT"
    const val ACTION_DISCONNECT = "com.resolo.phantom.action.DISCONNECT"
    const val ACTION_LOG_UPDATED = "com.resolo.phantom.action.LOG_UPDATED"
    const val ACTION_STATE_UPDATED = "com.resolo.phantom.action.STATE_UPDATED"
    const val ACTION_DASHBOARD_UPDATED = "com.resolo.phantom.action.DASHBOARD_UPDATED"
}
