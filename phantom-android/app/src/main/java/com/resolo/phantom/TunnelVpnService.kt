...
class TunnelVpnService : VpnService() {
    ...
    private val serviceLogCallback = object : PhantomTunnel.LogCallback {
    ...
    override fun onCreate() {
        ...
        PhantomTunnel.setLogCallback(serviceLogCallback)
    }
    ...
    private fun completeTunnelConnection(configuration: TunnelConfiguration, listenPort: Int) {
        ...
        val tunBridgeResult = PhantomTunnel.startTun2Socks(
    ...
    private fun closeInterface() {
        runCatching { PhantomTunnel.stopTun2Socks() }
    ...
    private fun refreshRuntimeTelemetry() {
        val configuration = activeConfiguration ?: TunnelPreferences.loadConfiguration(this)
        val runtimeSnapshot = TunnelRuntimeSnapshot.fromJsonString(PhantomTunnel.copyStatsJson())
    ...
    private fun ensureNotificationChannel() {
        ...
        channel.description = "Phantom Tunnel connection status"
    ...
    private fun buildNotification(status: String): Notification {
        ...
        return builder
            .setContentTitle("Phantom Tunnel")
    ...
    private companion object {
        const val NOTIFICATION_CHANNEL_ID = "phantom_tunnel_status"
