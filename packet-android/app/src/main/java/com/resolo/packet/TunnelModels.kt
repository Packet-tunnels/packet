...
object PacketDefaultProfiles {
    ...
    // Configuration values should be obtained from deploy-vps.sh output
    // See README.md for deployment instructions
    const val CHAIN_SERVER_URL = "" // e.g., "http://your-server:80"
    const val CHAIN_SECRET = "" // Generated by deploy-vps.sh
    const val CHAIN_EDGE = "" // e.g., "cdn-edge-ip:80"
    const val CHAIN_OBFS_KEY = "" // Generated by deploy-vps.sh
    const val CHAIN_TROJAN_URI = "" // Optional: custom trojan carrier configuration
